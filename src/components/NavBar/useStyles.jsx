const useStyles = () => {
  return {
      container:" w-full h-[60px] flex justify-between items-center px-4 bg-black/90 text-white fixed top-0",
      peImg:'w-[60px]',
    menu:" hidden md:flex ",
      ...
      mobile_menu_text:"py-1 text-4xl bg-black/40 rounded-md m-6",
