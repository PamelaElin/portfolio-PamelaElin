const useStyles = () => {
  return {
    container:'w-full h-full mt-12  flex justify-center items-center p-8 md:p-4',
    form:'flex flex-col max-w-[600px] w-full',
    textContact:'md:text-4xl text-3xl font-bold inline border-b-4 border-pink-600 text-gray-300 ',
